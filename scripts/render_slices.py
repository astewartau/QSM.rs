...
NAMES = {
    ...
    "unwrap_raw_laplacian_dirichlet": "Laplacian ROI-masked (unwrapped)",
    "unwrap_bfr_romeo": "ROMEO + V-SHARP",
    "unwrap_bfr_laplacian_neumann": "Laplacian (Neumann) + V-SHARP",
    "unwrap_bfr_laplacian_dirichlet": "Laplacian (ROI-masked) + V-SHARP",
    ...
    "unwrap_raw_laplacian_dirichlet": "Lap. ROI-masked",
