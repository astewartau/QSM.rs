...
NAMES = {
    ...
    "bgremove_msmv": "mSMV",
    "bgremove_lbv": "LBV",
    "bgremove_vsharp_msmv": "V-SHARP + mSMV",
    "bgremove_pdf_msmv": "PDF + mSMV",
    "bgremove_lbv_msmv": "LBV + mSMV",
    "inversion_tkd": "TKD",
    "inversion_tsvd": "TSVD",
...
WINDOWS = {
    ...
    "bgremove_vsharp_msmv": (-0.025, 0.025),
    "bgremove_pdf_msmv": (-0.025, 0.025),
    "bgremove_lbv_msmv": (-0.025, 0.025),
